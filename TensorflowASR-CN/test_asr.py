...
class ASR():
    ...
    def convert_to_onnx(self):
        ...
        tf2onnx.convert.from_function(self.encoder.inference,
                                      input_signature=[ tf.TensorSpec([None, None,1], dtype=tf.float32)], opset=13, output_path='models/offline/encoder.onnx')
        ...
        tf2onnx.convert.from_function(self.ctc_model.inference,
                                      ...
                                      output_path='models/offline/ctc_model.onnx')
        ...
        tf2onnx.convert.from_function(self.translator.inference,
                     ...
                     tf.TensorSpec([None, None, self.translator.dmodel], dtype=tf.float32),], opset=13,
                                      output_path='models/offline/translator.onnx')
...
if __name__ == '__main__':
    ...
    am_config = UserConfig(r'/Users/zhanjun/bishe/CN/TensorflowASR-CN/configs/am_data.yml',
                           r'/Users/zhanjun/bishe/CN/TensorflowASR-CN/configs/conformerS.yml')
    # am_config = UserConfig(r'/Users/zhanjun/bishe/CN/TensorflowASR-CN/configs/am_data.yml',
                           # r'/Users/zhanjun/bishe/CN/TensorflowASR-CN/configs/conformerS.yml')
    asr = ASR(am_config)
    # asr.save_weights('./models_large/models.h5')
    # asr.convert_to_onnx()
    i = 0
    s_time = time.time()
    while i < 10:
        # path = '/Users/zhanjun/PycharmProjects/audio_web/web/static/audio/upload.ogg'
        path = '/Users/zhanjun/bishe/dataset/AISHELL-1/dev/S0733/BAC009S0733W0479.wav'
        print(asr.stt(path))
        # path = input("path:")
        i += 1
    e_time = time.time()
