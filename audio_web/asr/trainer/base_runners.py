...
class BaseRunner():
    ...
    def __init__(self, config: dict):
        ...
        self.train_writer = tf.summary.create_file_writer(
            os.path.join(config["outdir"], "tensorboard_large", "train")
        )
        self.eval_writer = tf.summary.create_file_writer(
            os.path.join(config["outdir"], "tensorboard_large", "eval")
        )
    ...
    def _write_to_tensorboard(self,
                              ...
                              step: any,
                              stage: str = "train"):
        """Write variables to tensorboard_large."""
...
class BaseTrainer(BaseRunner):
    ...
    def _check_log_interval(self):
        ...
        if self.steps % self.running_config["log_interval_steps"] == 0:
            ...
            """Reset train metrics after save it to tensorboard_large."""
