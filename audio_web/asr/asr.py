...
def load_asr_model():
    am_config = UserConfig("/Users/zhanjun/PycharmProjects/audio_web/configs/am_data.yml",
                           "/Users/zhanjun/PycharmProjects/audio_web/configs/conformerL.yml")
    model = ASR(am_config)
    return model
...
#         path = '/Users/zhanjun/bishe/dataset/AISHELL-1/train/S0711/BAC009S0711W0130.wav'
#         print(asr.stt(path))
#         # path = input("path:")
#         i += 1
#     e_time = time.time()
