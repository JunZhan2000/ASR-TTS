...
def main():
    ...
    parser.add_argument(
        "--outdir",
        default="/remote-home/jzhan/download/TensorFlowTTS/Models/tacotron2",
        type=str, help="directory to save checkpoints."
    )
    parser.add_argument(
        "--config",
        default="/remote-home/jzhan/download/TensorFlowTTS/examples/tacotron2/conf/tacotron2.baker.v1.yaml",
