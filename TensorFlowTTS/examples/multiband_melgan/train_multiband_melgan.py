...
def main():
    ...
    parser.add_argument(
        "--outdir",
        default="/remote-home/jzhan/download/TensorFlowTTS/Models/multiband_melgan",
        type=str, help="directory to save checkpoints."
    )
    parser.add_argument(
        "--config",
        default="/remote-home/jzhan/download/TensorFlowTTS/examples/multiband_melgan/conf/multiband_melgan.baker.v1.yaml",
        type=str, help="yaml format configuration file."
    )

    parser.add_argument(
        "--resume",
        default="/remote-home/jzhan/download/TensorFlowTTS/Models/multiband_melgan/checkpoints/ckpt-200000",
        type=str,
        nargs="?",
