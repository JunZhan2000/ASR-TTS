...
@click.command()
@click.option("--base_path", default="/remote-home/jzhan/download/TensorFlowTTS/dump")
@click.option("--trimmed_dur_path", default="/remote-home/jzhan/download/TensorFlowTTS/dump/train/durations")
@click.option("--dur_path", default="/remote-home/jzhan/download/TensorFlowTTS/dump/valid/durations")
