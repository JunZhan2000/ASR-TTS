...
@click.command()
@click.option(
    "--yaml_path", default="/remote-home/jzhan/download/TensorFlowTTS/examples/fastspeech2/conf/fastspeech2.baker.v2.yaml"
)
@click.option("--dataset_path", default="/remote-home/jzhan/download/TensorFlowTTS/dump/train", type=str, help="Dataset directory")
@click.option("--text_grid_path", default="/remote-home/jzhan/download/TensorFlowTTS/baker_align", type=str)
@click.option("--output_durations_path", default="/remote-home/jzhan/download/TensorFlowTTS/dump/train/durations")
