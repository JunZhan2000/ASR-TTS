...
def main():
    ...
    parser.add_argument(
        "--train-dir",
        default="/remote-home/jzhan/download/TensorFlowTTS/dump/train/",
        type=str,
        help="directory including training data. ",
    )
    parser.add_argument(
        "--dev-dir",
        default="/remote-home/jzhan/download/TensorFlowTTS/dump/valid/",
        type=str,
    ...
    parser.add_argument(
        "--f0-stat",
        default="/remote-home/jzhan/download/TensorFlowTTS/dump/stats_f0.npy",
        type=str,
        help="f0-stat path.",
    )
    parser.add_argument(
        "--energy-stat",
        default="/remote-home/jzhan/download/TensorFlowTTS/dump/stats_energy.npy",
        type=str,
        help="energy-stat path.",
    )
    parser.add_argument(
        "--outdir",
        default="/remote-home/jzhan/download/TensorFlowTTS/Models/fastspeech2",
        type=str, help="directory to save checkpoints."
    )
    parser.add_argument(
        "--config",
        default="/remote-home/jzhan/download/TensorFlowTTS/examples/fastspeech2/conf/fastspeech2.baker.v2.yaml",
